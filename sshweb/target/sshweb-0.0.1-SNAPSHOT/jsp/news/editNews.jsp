...
window.onload=function ()
{
  ...
  <body>
    ...
    <s:hidden name="news.newsId" value="%{news.newsId}"></s:hidden>
    <table border="0">
    <tr>
    <td>
           新闻标题：
    ...
    <td>
    <s:textfield name="news.newsName" id="newsName" value="%{news.newsName}"/> 
    </td>
    </tr>
    <tr>
    <td>
    ...
    <td >
        <s:textfield name="news.newsSource" id="newsSource" value="%{news.newsSource}"/> 
	</td>
	</tr>
	<tr>
	<td >
	...
	<td>
		<s:textarea name="news.newsDetail" id="newsDetail" cols="100" rows="15" value="%{news.newsDetail}"/> 
	</td>
	</tr>
	<tr>
